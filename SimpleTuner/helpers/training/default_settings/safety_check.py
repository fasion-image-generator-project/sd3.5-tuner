...
def safety_check(args, accelerator):
    ...
    if (
        ...
        try:
            ...
            print("Warning: Unable to check system memory due to permission error. Using default value.")
            total_memory = 40960  # 기본값 (40GB RAM 가정)
        ...
        try:
            ...
            print("Warning: Unable to check system memory due to permission error.")
            total_memory_gb = 40  # 기본값 (40GB RAM 가정)
